    ...
    <div class="container">
        ...
        <nav>
            <ul>
                ...
                <li class="current"><a href="/admin/report/expertReport">Expert Report</a></li>
...
<script>
    $("#search").click(function () {
        ...
        $.ajax({
            type: "POST",
            url: "http://localhost:8080/bill/reportExpertOrdersDone",
            data: JSON.stringify(array),
            contentType: 'application/json; charset=utf-8',
            success: function (result) {
                $.each(result, function (index, value) {
                    msg += "<tr><td>" + value.expert.id + "</td><td>" + value.expert.name + "</td><td>" + value.expert.family +
                        "</td><td>" + value.numberOfRequest+"</td></tr>";
                });
